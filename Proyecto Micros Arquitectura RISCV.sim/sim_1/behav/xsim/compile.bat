...
REM
REM Generated by Vivado on Wed Jun 09 13:36:43 -0600 2021
...
echo "xvlog --incr --relax -prj test_RISCV_uniciclo_vlog.prj"
call xvlog  --incr --relax -prj test_RISCV_uniciclo_vlog.prj -log xvlog.log
